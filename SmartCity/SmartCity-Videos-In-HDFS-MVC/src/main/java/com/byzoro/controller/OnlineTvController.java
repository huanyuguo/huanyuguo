...
import com.byzoro.constant.Constants;
...
public class OnlineTvController {
	// TODO: 流式的视频播放
	@RequestMapping("/tv")
	@ResponseBody
	public void showTv(HttpServletRequest req, HttpServletResponse resp) throws Exception {
		String fpath = req.getParameter("fpath");
		System.out.println("路径为:"+fpath);
		if (fpath != null) {
